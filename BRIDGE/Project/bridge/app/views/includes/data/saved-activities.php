<div class="activities-list">
    <?php foreach ($data['saved_posts'] as $post) : ?>
        <article>
            <div class="article">
                <div class="activity-author">
                    <div class="fs-c-flex">
                        ...
                        <div class="c-fs-col-flex">
                            ...
                            <small class="elapsed-time"><?php echo getElapsedTime($post['posting_date']); ?>, enregistré <?php echo strtolower(getElapsedTime($post['action_date'])); ?></small>
                        </div>
                    </div>
                    <div class="c-dropdown noselect">
                        ...
                        <ul class="c-dropdown-items bl-dropdown">
                            ...
                            <li><a href="javascript:void(0)" class="pd-y-5 pd-x-10 link unsave-btn"><i class="fas fa-minus-circle fa-fw mr-r-10"></i>Supprimer de la playlist</a></li>
                        </ul>
                    </div>
                </div>
